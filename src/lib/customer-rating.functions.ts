...
export const analyzeCustomerRating = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    ...
    const { output } = await generateText({
      ...
      system:
        "أنت محلل ائتماني محترف. حلّل سلوك السداد لعميل بناءً على ملخص معاملاته وأعطه درجة صحة مالية (0-100) وتصنيفًا. كلما زاد السداد في الوقت وقلت المتأخرات ارتفعت الدرجة. excellent ≥ 85، good 70-84، average 50-69، risky 30-49، bad < 30. السبب بالعربية فقط ومختصر.",
